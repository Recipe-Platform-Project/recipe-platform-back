...
public class DeleteReviewResponseDto extends ResponseDto{
    ...
    private DeleteReviewResponseDto(String code, String message){
        super(code, message);
    }

    public static ResponseEntity<DeleteReviewResponseDto> success(){
        DeleteReviewResponseDto result = new DeleteReviewResponseDto(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
