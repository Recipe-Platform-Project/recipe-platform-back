...
public class PatchReviewResponseDto extends ResponseDto{
    ...
    private PatchReviewResponseDto(String code, String message){
        super(code, message);
    }

    public static ResponseEntity<PatchReviewResponseDto> success(){
        PatchReviewResponseDto result = new PatchReviewResponseDto(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
